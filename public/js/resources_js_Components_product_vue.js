...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h2", { staticClass: "text-orange my-3" }, [
        _vm._v("All Productass:")
      ]),
      _vm._v(" "),
      _c("router-link", { attrs: { to: "/addProduct" } }, [
        _c("button", { staticClass: "btn_1", attrs: { type: "submit" } }, [
          ...
          return _c(
            ...
            [
              _c("img", {
                ...
                attrs: { src: "uploades/" + product.image, alt: "" }
              }),
              _vm._v(" "),
              ...
              _c(
                ...
                [
                  ...
                  _c("h6", {
                    ...
                    domProps: {
                      textContent: _vm._s(
                        _vm.formatPrice(product.discount_price)
                      )
                    }
                  })
                ]
