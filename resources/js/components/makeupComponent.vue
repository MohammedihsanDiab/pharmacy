<template>
    <div class="site-wrap">
        ...
        <div class="site-section bg-light">
            <div class="container">
                <h2 class="text-center" style="font-size: 30px;margin-bottom: 70px;"> Makeup <span style="color:#75b239;">Products</span></h2>

                <div class="row">
                    <div  v-for="item in this.$store.state.search" :key="item.id" >
                        <div v-if="item.category == 'makeup'" class="col-sm-6 col-lg-4 text-center item mb-4 item-v2 ">
