                        ...
                        <div class="col-sm-8">
                            <div class="contact-form">
                                ...
                                <div class="form-group col-md-12 my-3"><textarea name="message" v-model="data.title"
                                    ...
                                    <div class="form-group col-md-12 my-4"><input type="button" @click="add()" name="submit" class="btn btn-primary pull-right" value="Add a product"></div>
...
export default (await import('vue')).defineComponent({
    ...
    created() {
        if (this.$store.state.token && this.$store.state.tokenadmin == 1) {
            this.data.owner = this.$store.state.owner;
    ...
    methods: {
        ...
        add() {
            ...
            data.append('owner', t.data.owner);
